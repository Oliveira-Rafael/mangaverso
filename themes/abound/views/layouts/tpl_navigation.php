            ...
            <div class="nav-collapse">
                <?php $this->widget('zii.widgets.CMenu', array(
                    ...
                    'items' => array(
                        ...
                        array('label' => 'Autor', 'url' => array('/autor/admin'), 'visible' => !Yii::app()->user->isGuest),
                        array('label' => 'Editora', 'url' => array('/editora/admin'), 'visible' => !Yii::app()->user->isGuest),
                        array('label' => 'Obra', 'url' => array('/obra/admin'), 'visible' => !Yii::app()->user->isGuest),
